    ...
    <div className="flex flex-row justify-between gap-2 mb-2">
      ...
      <NavLink
        className={({ isActive }) =>
          ...
          } text-[20px] font-bold bg-[#ecfeff] text-[#00598a] w-1/5 flex flex-row justify-between items-center`
        }
      ...
      <NavLink
        className={({ isActive }) =>
          `${
            isActive ? "opacity-30" : " opacity-100"
          } text-[20px] font-bold bg-[#ecfdf5] text-[#006045] w-1/5 flex flex-row justify-between items-center`
        }
      ...
      <NavLink
        className={({ isActive }) =>
          `${
            isActive ? "opacity-30" : " opacity-100"
          } text-[20px] font-bold bg-[#fefce8] text-[#894b00] w-1/5 flex flex-row justify-between items-center`
        }
      ...
      <NavLink
        className={({ isActive }) =>
          `${
            isActive ? "opacity-30" : " opacity-100"
          } text-[20px] font-bold bg-[#f5f3ff] text-[#8200db] w-1/5 flex flex-row justify-between items-center`
        }
      ...
      <NavLink
        className={({ isActive }) =>
          `${
            isActive ? "opacity-30" : " opacity-100"
          } text-[20px] font-bold bg-[#fef2f2] text-[#9f0712] w-1/5 flex flex-row justify-between items-center`
        }
