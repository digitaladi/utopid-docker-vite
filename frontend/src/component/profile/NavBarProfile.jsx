...
<div class="flex px-2 py-1 rounded-md  overflow-hidden max-w-md mx-auto">
        ...
        <input type="email" placeholder="Rechercher..." class="w-full outline-none bg-transparent text-gray-600 text-sm" />
      </div>
